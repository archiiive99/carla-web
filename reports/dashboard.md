...
**Summary:** 50 rows ✅, 7 rows ⚠️, 7 rows queued. §6.5 raise still active.
...
| 09-revisit-lamp-pole | Visible pole cylinder ground→lamp head | **✅** | 16.71 | 0.3063 | 21.87 | ~20 min | (this commit) |
