...
**Summary:** 15 rows ✅, 5 rows ⚠️, 14 rows queued. §6.5 raise still active.
...
| 14-revisit-buildings | LOD entry-filter on Buildings | **✅** | 11.03 | 0.2127 | 35.89 | ~15 min | (this commit) |
