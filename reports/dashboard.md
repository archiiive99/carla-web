...
**Summary:** 18 rows ✅, 6 rows ⚠️, 12 rows queued. §6.5 raise still active.
...
| 14-revisit-runtime-lod | Per-frame camera-tracked cull (Walls opt-in) | **✅** | 11.03 | 0.2127 | 35.89 | ~40 min | (this commit) |
