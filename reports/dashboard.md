...
**Summary:** 19 rows ✅, 6 rows ⚠️, 13 rows queued. §6.5 raise still active.
...
| 14-revisit-runtime-all | Opt 6 more sites into runtimeCull + coord bug fix | **✅** | 11.03 | 0.2128 | 35.88 | ~30 min | (this commit) |
