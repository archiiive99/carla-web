...
**Summary:** 30 rows ✅, 6 rows ⚠️, 12 rows queued. §6.5 raise still active.
...
| 08-clothes-pattern | Pants color separate from shirt | **✅** | 11.02 | 0.2125 | 35.93 | ~15 min | (this commit) |
