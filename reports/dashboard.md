...
**Summary:** 31 rows ✅, 6 rows ⚠️, 11 rows queued. §6.5 raise still active.
...
| 06-revisit-bias-by-altitude | Sun-altitude shadow bias ramp | **✅** | 16.73 | 0.3061 | 21.85 | ~15 min | (this commit) |
