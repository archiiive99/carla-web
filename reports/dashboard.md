...
**Summary:** 51 rows ✅, 7 rows ⚠️, 7 rows queued. §6.5 raise still active.
...
| 09-revisit-lamp-arm | Horizontal arm + head at outboard end | **✅** | 16.72 | 0.3063 | 21.87 | ~25 min | (this commit) |
